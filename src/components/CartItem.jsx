...
export default function CartItem({ props }) {
  ...
  useEffect(() => {
    setCart(
      cart.filter((cartItem) => {
        return cartItem.foodId === props.foodId
          ? (cartItem.foodQuantity = quantity)
  ...
  return (
    <>
      <div
        className="col-md-11 mx-auto mb-4 p-2 cart-item rounded-3 d-flex flex-wrap justify-content-center align-items-center"
        id="cart-item-id"
      >
